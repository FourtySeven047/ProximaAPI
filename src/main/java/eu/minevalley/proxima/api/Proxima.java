...
public final class Proxima {
    ...
    public static String generateUniqueRandomString(@Nonnull String table, @Nonnull String column,
                                                    @Nonnull Supplier<String> stringSupplier)
            throws IllegalArgumentException, SQLException {
        return provider.generateUniqueRandomString(table, column, stringSupplier);
    }
}