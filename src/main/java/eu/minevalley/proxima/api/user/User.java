...
import eu.minevalley.proxima.api.corporation.Member;
...
import eu.minevalley.proxima.api.user.social.Friendship;
import eu.minevalley.proxima.api.user.social.Marriage;
import eu.minevalley.proxima.api.user.statistics.Statistics;
...
public interface User extends Registrant {
    ...
    /**
     * Gets a set of the users installed smart apps.
     *
     * @return set of the users installed smart apps
     */
    @Nonnull
    @Contract(pure = true)
